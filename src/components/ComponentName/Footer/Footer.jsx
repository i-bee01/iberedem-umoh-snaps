        ...
        <section className="footer">
            <div className="footer__container">
                ...
                <div className="footer__menu">
                    <div>
                        <p>
                            <a href="/photographers" className="footer__link">For photographers</a>
                        </p>

                        <p>
                            <a href="/hire" className="footer__link">Hire Talent</a>
                        </p>

                        <p>
                            <a href="/inspiration" className="footer__link">Inspiration</a>
                        </p>
                        </div>
                    ...
                    {/* <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_2095_1312)">
                            ...
                            <g mask="url(#mask0_2095_1312)">
                                <path d="M15.75 0.937134H18.8171L12.1171 8.61428L20 19.0628H13.8286L8.99143 12.7271L3.46286 19.0628H0.392857L7.55857 10.8486L0 0.938562H6.32857L10.6943 6.72856L15.75 0.937134ZM14.6714 17.2228H16.3714L5.4 2.68142H3.57714L14.6714 17.2228Z" fill="#1E6655"/>
                            </g>
                        </g>
                        <defs>
